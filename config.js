...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "CRISS-AI-dJZkzBKb#0kiTh_a1DK3yPSBkPP7vpuO7WRparnvk_xjfPuDrBMM",
// add your Session Id 
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254790164860",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "boss denny",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ denny ᴠᴇᴠᴏ*",
// add bot owner name    
...
DEV: process.env.DEV || "254790164860",
